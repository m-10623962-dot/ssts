...
<div id="container">
        ...
        <img src="logo3.png" width="208" height="242"  align="bottom">
        </div>
        ...
        <div id="content">
          ...
          <div id="nav">
                    ...
                    <div id="main">
                        ...
                        <br>
                        <a href="aduan.php" target="_blank"><img src="banner4.jpg" height="20%" width="90%"></a><br><br>
                        <hr width="90%" align="left"><br>
                        <a href="pertandingan.php" target="_blank"><img src="banner5.jpg" height="20%" width="90%"></a>
